...
export class AddSongs1574687574284 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(
          `INSERT INTO ${this.tableName} (id, title, genre, url, lyrics, uploaded, isNew, countOfListening, artistId, addedById, albumName, duration) VALUES (1, 'Fighting The World', 'Heavy Metal | Power Metal | Epic Heavy Metal | American Heavy Metal | Battle Metal | Viking Metal | Warrior Metal | Symphonic Heavy Metal | Classic Heavy Metal', 'https://storage.googleapis.com/download/storage/v1/b/audio-files11/o/01.%20Fighting%20The%20World.mp3?generation=1574680231796761&alt=media', '${this.text1}', ${Date.now()}, true, 0, 1, null, 'Fighting The World', 231)`
        );

        await queryRunner.query(
          `INSERT INTO ${this.tableName} (id, title, genre, url, lyrics, uploaded, isNew, countOfListening, artistId, addedById, albumName, duration) VALUES (2, 'Defender', 'Heavy Metal | Power Metal | Epic Heavy Metal | American Heavy Metal | Battle Metal | Viking Metal | Warrior Metal | Symphonic Heavy Metal | Classic Heavy Metal', 'https://storage.googleapis.com/download/storage/v1/b/audio-files11/o/05.%20Defender.mp3?generation=1574680237123034&alt=media', '${this.text2}', ${Date.now()}, true, 0, 1, NULL, 'Fighting The World', 366)`
        );

        await queryRunner.query(
          `INSERT INTO ${this.tableName} (id, title, genre, url, lyrics, uploaded, isNew, countOfListening, artistId, addedById, albumName, duration) VALUES (3, 'Animals', 'Heavy Metal | Power Metal | Epic Heavy Metal | American Heavy Metal | Battle Metal | Viking Metal | Warrior Metal | Symphonic Heavy Metal | Classic Heavy Metal', 'https://storage.googleapis.com/download/storage/v1/b/audio-files11/o/02.%20Animals.mp3?generation=1574680233413720&alt=media', '${this.text3}', ${Date.now()}, true, 0, 1, NULL, 'Sign Of The Hammer', 215)`
        );

        await queryRunner.query(
          `INSERT INTO ${this.tableName} (id, title, genre, url, lyrics, uploaded, isNew, countOfListening, artistId, addedById, albumName, duration) VALUES (4, 'Death Tone', 'Heavy Metal | Power Metal | Epic Heavy Metal | American Heavy Metal | Battle Metal | Viking Metal | Warrior Metal | Symphonic Heavy Metal | Classic Heavy Metal', 'https://storage.googleapis.com/download/storage/v1/b/audio-files11/o/01.%20Death%20Tone.mp3?generation=1574680235768642&alt=media', '${this.text4}', ${Date.now()}, true, 0, 1, NULL, 'Battle Hymns', 291)`
        );

        await queryRunner.query(
          `INSERT INTO ${this.tableName} (id, title, genre, url, lyrics, uploaded, isNew, countOfListening, artistId, addedById, albumName, duration) VALUES (5, 'Thor [The Powerhead]', 'Heavy Metal | Power Metal | Epic Heavy Metal | American Heavy Metal | Battle Metal | Viking Metal | Warrior Metal | Symphonic Heavy Metal | Classic Heavy Metal', 'https://storage.googleapis.com/download/storage/v1/b/audio-files11/o/03.%20Thor%20%5BThe%20Powerhead%5D.mp3?generation=1574680233761794&alt=media', '${this.text5}', ${Date.now()}, true, 0, 1, NULL, 'Sign Of The Hammer', 324)`
        );

        await queryRunner.query(
          `INSERT INTO ${this.tableName} (id, title, genre, url, lyrics, uploaded, isNew, countOfListening, artistId, addedById, albumName, duration) VALUES (6, 'Fast Taker', 'Heavy Metal | Power Metal | Epic Heavy Metal | American Heavy Metal | Battle Metal | Viking Metal | Warrior Metal | Symphonic Heavy Metal | Classic Heavy Metal', 'https://storage.googleapis.com/download/storage/v1/b/audio-files11/o/03.%20Fast%20Taker.mp3?generation=1574680230859252&alt=media', '${this.text6}', ${Date.now()}, true, 0, 1, NULL, 'Battle Hymns', 237)`
        );

        await queryRunner.query(
          `INSERT INTO ${this.tableName} (id, title, genre, url, lyrics, uploaded, isNew, countOfListening, artistId, addedById, albumName, duration) VALUES (7, 'Carry On', 'Heavy Metal | Power Metal | Epic Heavy Metal | American Heavy Metal | Battle Metal | Viking Metal | Warrior Metal | Symphonic Heavy Metal | Classic Heavy Metal', 'https://storage.googleapis.com/download/storage/v1/b/audio-files11/o/03.%20Carry%20On.mp3?generation=1574680240112184&alt=media', '${this.text7}', ${Date.now()}, true, 0, 1, NULL, 'Fighting The World', 258)`
        );

        await queryRunner.query(
          `INSERT INTO ${this.tableName} (id, title, genre, url, lyrics, uploaded, isNew, countOfListening, artistId, addedById, albumName, duration) VALUES (8, 'Each Dawn I Die', 'Heavy Metal | Power Metal | Epic Heavy Metal | American Heavy Metal | Battle Metal | Viking Metal | Warrior Metal | Symphonic Heavy Metal | Classic Heavy Metal', 'https://storage.googleapis.com/download/storage/v1/b/audio-files11/o/02.%20Each%20Dawn%20I%20Die.mp3?generation=1574680232242331&alt=media', '${this.text8}', ${Date.now()}, true, 0, 1, null, 'Hail To England', 261)`
        );

        await queryRunner.query(
          `INSERT INTO ${this.tableName} (id, title, genre, url, lyrics, uploaded, isNew, countOfListening, artistId, addedById, albumName, duration) VALUES (9, 'Hail To England', 'Heavy Metal | Power Metal | Epic Heavy Metal | American Heavy Metal | Battle Metal | Viking Metal | Warrior Metal | Symphonic Heavy Metal | Classic Heavy Metal', 'https://storage.googleapis.com/download/storage/v1/b/audio-files11/o/04.%20Hail%20To%20England.mp3?generation=1574680234556914&alt=media', '${this.text9}', ${Date.now()}, true, 0, 1, null, 'Hail To England', 264)`
        );

        await queryRunner.query(
          `INSERT INTO ${this.tableName} (id, title, genre, url, lyrics, uploaded, isNew, countOfListening, artistId, addedById, albumName, duration) VALUES (10, 'Warriors Of The World United', 'Heavy Metal | Power Metal | Epic Heavy Metal | American Heavy Metal | Battle Metal | Viking Metal | Warrior Metal | Symphonic Heavy Metal | Classic Heavy Metal', 'https://storage.googleapis.com/download/storage/v1/b/audio-files11/o/08.%20Warriors%20Of%20The%20World%20United.mp3?generation=1574680238134545&alt=media', '${this.text10}', ${Date.now()}, true, 0, 1, NULL, 'Warriors Of The World [Limited Edition. Super Audio CD]', 356)`
        );
    }
